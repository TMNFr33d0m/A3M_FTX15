...
// Load Task Predefines (Messages and shit) 
execVM "scripts\2ABCT_MPTaskPreDef.sqf"; 

execVM "scripts\2ABCT_CounterInsMission.sqf"; 

execVM "scripts\RBMP.sqf"; 
...
[getMarkerPos "Base"," FOB Legend",300,200,180,0,[]] spawn BIS_fnc_establishingShot;
